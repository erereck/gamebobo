...
export const PROJECT_PROMISES = [
  ...
  { id: 'new-every-run', label: 'Cada partida é diferente', pitch: 'O jogo sempre encontra outro caminho.', fromYear: 1980, genres: ['puzzle', 'strategy', 'rpg', 'simulation'], focuses: ['innovation', 'systems'], audience: 'hardcore', complexity: 2, reach: .03, quality: 1, innovation: 4, bugRisk: 2 },
  ...
  { id: 'player-tools', label: 'Ferramentas para jogadores', pitch: 'O público também cria parte da diversão.', fromYear: 1993, genres: ['simulation', 'strategy', 'puzzle'], focuses: ['systems', 'innovation'], audience: 'hardcore', complexity: 3, reach: .08, quality: 1, innovation: 3, bugRisk: 3 },
  { id: 'online-community', label: 'Comunidade online', pitch: 'O jogo continua quando você sai.', fromYear: 1996, genres: ['sports', 'action', 'rpg', 'simulation'], focuses: ['multiplayer'], audience: 'balanced', complexity: 3, reach: .14, quality: 1, innovation: 2, bugRisk: 4 },
]
...
export function projectPromiseCost(baseCost, baseMonths, promiseId, scaleId) {
  ...
  return Math.round(baseCost * ((baseMonths + extraMonths) / baseMonths))
}
