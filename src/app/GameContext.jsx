...
export function GameProvider({ children }) {
  ...
  const dispatch = useCallback(action => {
    ...
    playSound(sound, state.settings.sound)
    rawDispatch(action)
  ...
  }, [dispatch, state.currentProject, state.currentContract, state.queue.length])
  ...
  const value = useMemo(() => ({
    ...
    resetModalOpen,
    setResetModalOpen,
  }), [state, dispatch, view, projectModalOpen, resetModalOpen])
